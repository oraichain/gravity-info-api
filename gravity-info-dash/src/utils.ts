...
import { Attestation, DepositWithMetadata, Erc20Metadata, EthInfo, GravityInfo } from './types';

/// of some kind
export function getMetadataFromList(erc20: string, metadata: Array<Erc20Metadata>) {
...
export function amountToFraction(erc20: string, amount: number, metadata: Array<Erc20Metadata>) {
...
/// on Ethereum
export function getNotExecutedBatches(gravityBridgeInfo: GravityInfo, ethBridgeInfo: EthInfo) {
  let ret = [];
